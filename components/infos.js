    ...
    <TileWrapper numOfPages={3} id="info">
      ...
      <TileContent>
        <Tile
          ...
          renderContent={({ progress }) => (
            <InfoContainer id="om-oss">
              <div className="mt-20 md:mt-0 w-full h-36 md:h-full bg-slate-400 flex justify-center items-center ">
              ...
              <InfoRight progress={progress}>
                <span className="mt-20 text-xl font-semibold flex flex-col gap-2   text-slate-700">
        ...
        <Tile
          ...
          renderContent={({ progress }) => (
            <InfoContainer>
              <div className="mt-10 md:mt-0 w-full h-48 md:h-full bg-slate-400 flex justify-center items-center ">
                <InfoLeft progress={progress}>
                  <span className=" md:text-5xl font-semibold  tracking-tight">
        ...
        <Tile
          ...
          renderContent={({ progress }) => (
            <InfoContainer>
              ...
              <InfoRight progress={progress}>
                <span className=" md:text-2xl font-semibold   text-slate-700">
